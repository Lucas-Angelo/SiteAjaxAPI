...
function executaPesquisa () {
    ...
    xhr.open('GET', `http://newsapi.org/v2/top-headlines?country=br&category=health&apiKey=${API_KEY}`)
    xhr.send();
}

document.getElementById('cateSaude').addEventListener('click', executaPesquisa);
