...
function executaPesquisa () {
    ...
    xhr.open('GET', `http://newsapi.org/v2/top-headlines?country=br&category=entertainment&apiKey=${API_KEY}`)
    xhr.send();
}

document.getElementById('cateEntreterimento').addEventListener('click', executaPesquisa);
