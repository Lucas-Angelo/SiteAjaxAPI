...
function executaPesquisa () {
    ...
    xhr.open('GET', `http://newsapi.org/v2/top-headlines?country=br&category=technology&apiKey=${API_KEY}`)
    xhr.send();
}

document.getElementById('cateTecnologia').addEventListener('click', executaPesquisa);
