...
function executaPesquisa () {
    ...
    xhr.open('GET', `http://newsapi.org/v2/top-headlines?country=br&category=science&apiKey=${API_KEY}`)
    xhr.send();
}

document.getElementById('cateCiencia').addEventListener('click', executaPesquisa);
