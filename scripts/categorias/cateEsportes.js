...
function executaPesquisa () {
    ...
    xhr.open('GET', `http://newsapi.org/v2/top-headlines?country=br&category=sports&apiKey=${API_KEY}`)
    xhr.send();
}

document.getElementById('cateEsportes').addEventListener('click', executaPesquisa);
