...
function executaPesquisa () {
    ...
    xhr.open('GET', `https://newsapi.org/v2/everything?sources=blasting-news-br&apiKey=${API_KEY}`)
    xhr.send();
}

document.getElementById('fonteBlas').addEventListener('click', executaPesquisa);
